...
public interface SaleRepository extends JpaRepository<Sale, Long> {
    ...
    @Query(
        "SELECT new io.codekaffee.dsvendas.dto.SaleSumDTO(obj.seller, SUM(obj.amount)) "
    ...
    @Query(
        "SELECT new io.codekaffee.dsvendas.dto.SaleSuccessDTO(obj.seller, SUM(obj.visited), SUM(obj.deals))"
        + "FROM Sale AS obj GROUP BY obj.seller"
    )
